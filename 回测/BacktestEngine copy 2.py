...
class BacktestEngine:
    ...
    def rank_signals(self, today_signal, date):
        ...
        if self.buy_priority == 'volume':
            ...
            merged = merged.sort_values('turnover', ascending=False)
...
if __name__ == '__main__':
    engine = create_engine(
        ...
        #     'code': [...]
        # })
    signal_df = pd.read_sql("select stock_code as code,trade_date as date from stock_abnormal_monitor",con=engine)
    sell_config = {
    'total_profit': 0.2,          # 总盈利20%
